...
class CatagoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create catagory" do
    assert_difference('Catagory.count') do
      post catagories_url, params: { catagory: { slug: @catagory.slug, title: @catagory.title } }
    end
  ...
  test "should update catagory" do
    patch catagory_url(@catagory), params: { catagory: { slug: @catagory.slug, title: @catagory.title } }
